...
public class NoteAdapter3 extends FirestoreRecyclerAdapter<Note3, NoteAdapter3.NoteHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull NoteHolder holder, int position, @NonNull Note3 model) {
    ...
    public NoteHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.note_item3,
                parent, false);
